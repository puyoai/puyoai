...
bool ConnectorManagerLinux::GetActions(
    int frame_id, vector<PlayerLog>* log) {
  log->clear();
...
void ConnectorManagerLinux::DontWaitTimeout() {
  dont_wait_timeout_ = true;
}
