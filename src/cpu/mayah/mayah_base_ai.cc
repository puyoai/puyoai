...
DropDecision MayahBaseAI::thinkByBeamSearch(int /*frameId*/, const CoreField& field, const KumipuyoSeq& seq,
...
SearchResult MayahBaseAI::run(const std::vector<State>& initialStates, KumipuyoSeq seq, int maxSearchTurns) const
{
...
std::pair<double, int> MayahBaseAI::evalSuperLight(const CoreField& fieldBeforeRensa) const
{
    int maxChains = 0;
