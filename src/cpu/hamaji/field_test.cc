...
TEST(FieldTest, ChainAndScoreTest) {
  testUrl("50745574464446676456474656476657564547564747676466766747674757644657575475755", 19, 175080);
  testUrl("500467767675744454754657447767667644674545455767477644457474656455446775455646", 19, 175080);
  testUrl("550050455045451045745074745074645067674067674056567056567515167444416555155", 2, 38540);
  testUrl("50550040455075451075745064745064645067674057674747574776567675156644415555155", 3, 43260);
  testUrl("550040455075451775745464745464645467674457674147574776567675156644415555155", 4, 50140);
  ...
  testUrl("444444444444444444444444444444444444444444444444444444444444444444444444", 1, 7200);

  testUrl("400005500005400005500004400", 2, 420);
}
