#include "capture/images_source.h"
    ...
    stop_(false)
{
    ...
    //TODO(mayah): comment out for SDL2 migration
#if 0
...
UniqueSDLSurface Images::getNextFrame()
{
    prev_index_ = index_;
    SDL_Surface* surface = IMG_Load(images_[index_].c_str());
    if (surface == NULL) {
