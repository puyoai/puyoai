#include "capture/recognition/es/recognizer.h"

#include <algorithm>
#include <vector>
#include <memory>

#include "capture/recognition/es/classifier_features.h"

using namespace std;

ESRecognizer::ESRecognizer()
{
    for (int i = 0; i < NUM_RECOGNITION; ++i)
        arows[i].reset(new Arow(40 * 43 * 3));
...
RealColor ESRecognizer::recognize(const double features[40 * 43 * 3]) const
{
